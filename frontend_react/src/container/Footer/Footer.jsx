  ...
  return (
    <>
      <h2 className="head-text">
        Impressed? Of course you are impressed! Ping me and lets have a chat!!!
      </h2>

      <div className="app__footer-cards">
        <div className="app__footer-card">
          <img src={images.email} alt="email" />
          <a href="mailto:ppgeorge21@hotmail.com" className="p-text">ppgeorge21@hotmail.com</a>
        </div>
        <div className="app__footer-card">
          <img src={images.mobile} alt="mobile" />
          <a href="tel: +1 (123456789)" className="p-text">+1 (123456789)</a>
        </div>
      </div>
